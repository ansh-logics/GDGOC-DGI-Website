...
export default function BubbleMenu({
  ...
  const containerClassName = [
    ...
    // Only apply default positioning if no custom className with positioning is provided
    !className?.includes('bottom') && !className?.includes('top') ? 'left-0 right-0 top-8' : '',
      ...
      <style>{`
        ...
        @media (max-width: 899px) {
          ...
          .bubble-menu-items .pill-link {
            ...
            padding: clamp(1.5rem, 3vh, 2rem) clamp(2rem, 4vw, 3rem) !important;
                  ...
                  style={
                    {
                      ...
                      padding: 'clamp(2.5rem, 4vh, 4rem) clamp(3rem, 4vw, 5rem)',
